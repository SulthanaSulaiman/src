...
public class ForwardLoadVO {
    ...
    public ArrayList getStageOrderList() {
        return stageOrderList;
    }

    public void setStageOrderList(ArrayList stageOrderList) {
    ...
    public String getForwardFromDate() {
        return forwardFromDate;
    }

    public void setForwardFromDate(String forwardFromDate) {
        this.forwardFromDate = forwardFromDate;
    }

    public String getForwardToDate() {
        return forwardToDate;
    }

    public void setForwardToDate(String forwardToDate) {
