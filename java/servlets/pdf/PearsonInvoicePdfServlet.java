 ...
 * @author Aravindhanj
 */
public class PearsonInvoicePdfServlet extends HttpServlet {

    private static Font headerFont = new Font(Font.FontFamily.HELVETICA, 13, Font.BOLD);
    ...
    boolean pearsonClientChk=false;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        while (invoiceLineIterator.hasNext()) {
            ...
            String key = invoiceLine.getLineItemNo();
...
if(billingLocation.equals("1")){
        ...
        logoPath = logoPath + File.separator + "webimages\\logopng.png";
            ...
            PdfPCell cellhsn = new PdfPCell(new Paragraph("HSN/SAC: ", subFont));
...
if (billingLocation.equals("1")) {
    ...
    nestedTable.addCell(celltamil);
            ...
            String buyerDetails = "";
            String client = projInfo.getClient();
            pearsonClientChk=false;

            if(projInfo.getClient().startsWith("Pearson")){
                pearsonClientChk=true;
            }
...
disableBorders(poNum);
            ...
            //float[] lineItemsWidths = {7f, 7f, 25f, 9f, 9f, 9f, 9f, 10f};
             ...
             float[] lineItemsWidth1 = {7f, 7f, 25f, 8f, 10f, 10f, 10f, 10f,10f};

            float[] lineItemsWidth3 = {7f, 7f, 25f, 8f, 10f, 10f, 10f, 10f};


            int width=0;

            float[] lineItemsWidth2 = {10f, 7f, 7f, 25f, 8f, 10f, 10f, 10f, 10f};
...
String numbtowordsCur1="";
            if (!totalInvoiceLine.getInvoiceTotal().toString().equals("null") && !totalInvoiceLine.getInvoiceTotal().toString().equals("0.0")) {
                Row = new PdfPCell(new Paragraph(currencySymbol+" " + numberFormat.format(Double.parseDouble(totalInvoiceLine.getInvoiceTotal().toString())), smallBold));
                 numtocurrency=totalInvoiceLine.getInvoiceTotal().toString();
                 numtocurrency=numberFormat.format(Double.parseDouble(totalInvoiceLine.getInvoiceTotal()));
                //numtocurrency=String.valueOf(numberFormat.format(Double.parseDouble(totalInvoiceLine.getPreviouslyInvoicedValue().toString())));
                 ...
                 System.out.println("split"+numtocurrency);
                        ...
                        numbtowordsCur+=" "+numToword.convert(Long.parseLong(numtocurrency2[1]));
                         ...
                         if(currencyUnicode.equals("USD")){
                             System.out.println("chkcu"+currencyUnicode);
...
document.add(new Paragraph("\n"));
            ...
            document.add(new Paragraph(" "+numbtowordsCur1+numbtowordsCur,smallBold));
//numbtowordsCur
            }
 else{
            ...
            if (billingLocation.equals("1")) {
                ...
                document.add(new Chunk("A/C Number    : 64101557450 ",subFont));
                ...
                document.add(new Chunk("of S4Carlisle Publishing Services Pvt. Ltd held with OCBC Bank\n",small));
                document.add(new Chunk("Bank address : ",subFont));
                ...
                image3.setAbsolutePosition(340,110);
               ...
               //image1.setAlignment(50);
                ...
                document.add(new Paragraph("\n\n\n\n\n\n\n"));
                document.add(new Paragraph("Wire Transaction Information:", subFontUL));
                document.add(new Chunk("Kindly credit to Bank of America ",small));
                document.add(new Chunk("(SWIFT ID: BOFAUS3N) ",subFont));
                document.add(new Chunk(" for full and credit to:\n",small));
                document.add(new Chunk("A/C Number    : 446033003421 ",subFont));
                document.add(new Chunk("of S4Carlisle Transmedia Services Inc held with Bank of America\n",small));
                document.add(new Chunk("Bank address : ",subFont));
                document.add(new Chunk("10400 Old Georgetown road, MD 20814\n",small));
                document.add(new Chunk("Routing Number (ACH): 052001633\n",subFont));
   ...
   document.add(new Paragraph("\n"));
           ...
           if (billingLocation.equals("1")) {
            ...
            image2.setAbsolutePosition(340,110);
