...
public class ChennaiProductionRpt1ARC

{
 ...
 public ChennaiProductionRpt1ARC() /* this method continously checks the server time everyday*/
     {
   		/*getServerTime();
   		timer1 = new Timer();
...
//D:\\Sun\\AppServer\\domains\\domain1\\applications\\j2ee-modules\\pathfinder\\GPXL Data
		String XLFolder = "X:\\Pathfinder\\CPR\\V2_Reports\\Archive Status-"+db_timezone_code+"\\";
		String HTMFolder = "D:\\Sun\\AppServer\\domains\\domain1\\applications\\j2ee-modules\\pathfinder\\GPHTM Data\\Archive Status-"+db_timezone_code+"\\";
		


		/*String XLFolder = "C:\\Sun\\AppServer\\domains\\domain1\\applications\\j2ee-modules\\pathfinder\\GPXL Data\\Archive Status-"+db_timezone_code+"\\";
		String HTMFolder = "C:\\Sun\\AppServer\\domains\\domain1\\applications\\j2ee-modules\\pathfinder\\GPHTM Data\\Archive Status-"+db_timezone_code+"\\";*/
	...
	if(!attachmentsDir.exists())
	 {		
             attachmentsDir.mkdirs();		
				...
				String xlfilename = "Archive Status-"+db_timezone_code+".xls";
	...
	if(!attachmentsDir2.exists())
	 {
             attachmentsDir2.mkdirs();		
				...
				String htmfilename = "Archive Status-"+db_timezone_code+".htm";
...
/*** end of first style **/
			...
			headerCell1.setCellValue("Archive Status");
...
ResultSet rsGetDueDate = statement.executeQuery("select distinct(date_format(a.due_date,'%d-%b-%y')),dayname(a.due_date),date_format(current_timestamp(),'%d-%b-%y') from chapter a,projects b where (a.ship_date is null and a.proj_id=b.proj_id and a.chapter_status=1 and a.chapter_deleted=0 and b.project_status <> '2' and a.stage ='ARC') or (a.ship_date='0000-00-00 00:00:00' and a.proj_id=b.proj_id and a.chapter_status=1 and a.chapter_deleted=0 and b.project_status <> '2' and a.stage ='ARC') order by a.due_date");
...
//Get the projects which does not have due date
		       ...
		       dueTZ_estimatedDateTime.clear();
                    ...
                    // ResultSet rsNoDue=statement.executeQuery("select distinct(b.proj_id),b.proj_name,c.stage,a.chapter_no,a.chapter_id,a.remark,date_format(a.estimated_time,'%d-%b-%y'),date_format(a.receipt_date,'%d-%b-%y'),date_format(a.estimated_time,'%h:%i %p'),a.mss_count,date_format(a.estimated_time,'%d-%m-%Y %h:%i %p') from chapter a, projects b, project_stage c,client g,projectgroup f where (a.ship_date is null or a.ship_date='0000-00-00 00:00:00') and c.stage_code=a.stage and a.proj_id=b.proj_id and a.due_date_received='0'  and a.stage ='ARC' order by a.estimated_time");
...
Arc_NoDue="select distinct(b.proj_id),b.proj_name,c.stage,a.chapter_no,a.chapter_id,a.remark,date_format(a.estimated_time,'%d-%b-%y'),date_format(a.receipt_date,'%d-%b-%y'),date_format(a.estimated_time,'%h:%i %p'),a.mss_count,date_format(a.estimated_time,'%d-%m-%Y %h:%i %p') from chapter a, projects b, project_stage c where (a.ship_date is null or a.ship_date='0000-00-00 00:00:00') and c.stage_code=a.stage and a.proj_id=b.proj_id and a.due_date_received='0' and a.stage ='ARC' and a.chapter_status=1 and a.chapter_deleted=0 and b.project_status <> '2' ";
...
System.out.println("htmfilename:"+htmfilename);
		...
		{
			Arc_NoDue="select distinct(b.proj_id),b.proj_name,c.stage,a.chapter_no,a.chapter_id,a.remark,date_format(a.estimated_time,'%d-%b-%y'),date_format(a.receipt_date,'%d-%b-%y'),date_format(a.estimated_time,'%h:%i %p'),a.mss_count,date_format(a.estimated_time,'%d-%m-%Y %h:%i %p') from chapter a, projects b, project_stage c where (a.ship_date is null or a.ship_date='0000-00-00 00:00:00') and c.stage_code=a.stage and a.proj_id=b.proj_id and a.due_date_received='0' and a.stage ='ARC' and a.chapter_status=1 and a.chapter_deleted=0 and b.project_status <> '2' order by a.estimated_time";
...
//System.out.println("loop_DueDate:"+dueDate_List);
		...
		//System.out.println("dataStart_Row:"+i);
					...
					String dispDataQuery1 = "select b.proj_name, date_format(a.due_date,'%d-%b-%y'), c.stage,b.proj_id,a.stage,date(a.due_date),a.stage,a.due_date_received,date_format(a.receipt_date,'%d-%b-%y'),a.chapter_process from chapter a, projects b, project_stage c where (a.chapter_no not like '%To Delete%'  and a.ship_date is null and c.stage_code=a.stage and a.proj_id=b.proj_id and date_format(a.due_date,'%d-%b-%y')='"+loop_DueDate+"' and a.due_date_received='1' and a.chapter_status=1 and a.chapter_deleted=0 and b.project_status <> '2' and a.stage ='ARC' )or(a.chapter_no not like '%To Delete%' and a.ship_date = '0000-00-00 00:00:00' and c.stage_code=a.stage and a.proj_id=b.proj_id  and date_format(a.due_date,'%d-%b-%y')='"+loop_DueDate+"' and a.due_date_received='1' and a.chapter_status=1 and a.chapter_deleted=0 and b.project_status <> '2' and a.stage ='ARC' ) group by a.stage,a.proj_id,a.due_date order by a.due_date ";
