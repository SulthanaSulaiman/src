...
public void ChennaiProductionReport(){
	...
	con = DriverManager.getConnection("jdbc:mysql://10.1.1.6:3306/s4?jdbcCompliantTruncation=false&zeroDateTimeBehavior=convertToNull", "pftest", "pftest");
...
//D:\\Sun\\AppServer\\domains\\domain1\\applications\\j2ee-modules\\pathfinder\\GPXL Data
		String XLFolder = "X:\\Pathfinder\\CPR\\RPC Status-"+db_timezone_code+"\\";
...
ResultSet rsGetDueDate = statement.executeQuery("select distinct(date_format(a.due_date,'%d-%b-%y')),dayname(a.due_date),date_format(current_timestamp(),'%d-%b-%y') from chapter a,projects b where (a.ship_date is null and a.proj_id=b.proj_id and a.stage  in ('DES','DESUPD','DESCXS','DESEVA')) or (a.ship_date='0000-00-00 00:00:00' and a.proj_id=b.proj_id and a.stage  in ('DES','DESUPD','DESCXS','DESEVA')) order by a.due_date");
...
//Get the projects which does not have due date
		       ...
		       dueTZ_estimatedDateTime.clear();
                    ...
                    // ResultSet rsNoDue=statement.executeQuery("select distinct(b.proj_id),b.proj_name,c.stage,a.chapter_no,a.chapter_id,a.remark,date_format(a.estimated_time,'%d-%b-%y'),date_format(a.receipt_date,'%d-%b-%y'),date_format(a.estimated_time,'%h:%i %p'),a.mss_count,date_format(a.estimated_time,'%d-%m-%Y %h:%i %p') from chapter a, projects b, project_stage c,client g,projectgroup f where (a.ship_date is null or a.ship_date='0000-00-00 00:00:00') and c.stage_code=a.stage and a.proj_id=b.proj_id and a.due_date_received='0'  and a.stage   in ('DES','DESUPD','DESCXS','DESEVA') order by a.estimated_time");
...
Arc_NoDue="select distinct(b.proj_id),b.proj_name,c.stage,a.chapter_no,a.chapter_id,a.remark,date_format(a.estimated_time,'%d-%b-%y'),date_format(a.receipt_date,'%d-%b-%y'),date_format(a.estimated_time,'%h:%i %p'),a.mss_count,date_format(a.estimated_time,'%d-%m-%Y %h:%i %p') from chapter a, projects b, project_stage c,client g,projectgroup f where (a.ship_date is null or a.ship_date='0000-00-00 00:00:00') and c.stage_code=a.stage and a.proj_id=b.proj_id and a.due_date_received='0' and a.stage   in ('DES','DESUPD','DESCXS','DESEVA') ";
...
//System.out.println("Arc_NoDue_Count:"+Arc_NoDue_Count);
	...
	if(Arc_NoDue_Count==1)
		{
System.out.println("htmfilename:"+htmfilename);
			Arc_NoDue="select distinct(b.proj_id),b.proj_name,c.stage,a.chapter_no,a.chapter_id,a.remark,date_format(a.estimated_time,'%d-%b-%y'),date_format(a.receipt_date,'%d-%b-%y'),date_format(a.estimated_time,'%h:%i %p'),a.mss_count,date_format(a.estimated_time,'%d-%m-%Y %h:%i %p') from chapter a, projects b, project_stage c where (a.ship_date is null or a.ship_date='0000-00-00 00:00:00') and c.stage_code=a.stage and a.proj_id=b.proj_id and a.due_date_received='0' and a.stage   in ('DES','DESUPD','DESCXS','DESEVA') ";

		}
	else if(Arc_NoDue_Count>1)
		{
			Arc_NoDue="select distinct(b.proj_id),b.proj_name,c.stage,a.chapter_no,a.chapter_id,a.remark,date_format(a.estimated_time,'%d-%b-%y'),date_format(a.receipt_date,'%d-%b-%y'),date_format(a.estimated_time,'%h:%i %p'),a.mss_count,date_format(a.estimated_time,'%d-%m-%Y %h:%i %p') from chapter a, projects b, project_stage c where (a.ship_date is null or a.ship_date='0000-00-00 00:00:00') and c.stage_code=a.stage and a.proj_id=b.proj_id and a.due_date_received='0' and a.stage   in ('DES','DESUPD','DESCXS','DESEVA') order by a.estimated_time";
...
//System.out.println("loop_DueDate:"+dueDate_List);
		...
		//System.out.println("dataStart_Row:"+i);
					...
					String dispDataQuery1 = "select b.proj_name, date_format(a.due_date,'%d-%b-%y'), c.stage,b.proj_id,a.stage,date(a.due_date),a.stage,a.due_date_received,date_format(a.receipt_date,'%d-%b-%y'),a.chapter_process from chapter a, projects b, project_stage c,client g,projectgroup h where (a.chapter_no not like '%To Delete%'  and a.ship_date is null and c.stage_code=a.stage and a.proj_id=b.proj_id and date_format(a.due_date,'%d-%b-%y')='"+loop_DueDate+"' and a.due_date_received='1'  and a.stage   in ('DES','DESUPD','DESCXS','DESEVA'))or(a.chapter_no not like '%To Delete%' and a.ship_date = '0000-00-00 00:00:00' and c.stage_code=a.stage and a.proj_id=b.proj_id  and date_format(a.due_date,'%d-%b-%y')='"+loop_DueDate+"' and a.due_date_received='1'  and a.stage   in ('DES','DESUPD','DESCXS','DESEVA')) group by a.stage,a.proj_id,a.due_date order by a.due_date ";
...
//					System.out.println("proj_Name:"+proj_Name);
				...
				//System.out.println("select a.chapter_no,a.chapter_id,date_format(a.estimated_time,'%d-%b-%y'),date(a.estimated_time),date_format(a.estimated_time,'%h:%i %p'),a.remark from chapter a where (a.ship_date is null and a.proj_id='"+proj_id+"' and a.stage='"+stge+"' and date_format(a.due_date,'%d-%b-%y')='"+due_dt+"') or (a.ship_date = '0000-00-00 00:00:00' and a.proj_id='"+proj_id+"' and a.stage='"+stge+"' and date_format(a.due_date,'%d-%b-%y')='"+due_dt+"')");
					  ...
					  ResultSet rsChap=statement.executeQuery("select a.chapter_no,a.chapter_id,date(a.estimated_time),date_format(a.estimated_time,'%d-%b-%y'),date_format(a.estimated_time,'%h:%i %p'),a.remark,date_format(a.estimated_time,'%d-%m-%Y %h:%i %p') from chapter a where (a.ship_date is null and a.proj_id='"+proj_id+"' and a.stage='"+stge+"' and date_format(a.due_date,'%d-%b-%y')='"+due_dt+"' and a.due_date_received='1') or (a.ship_date = '0000-00-00 00:00:00' and a.proj_id='"+proj_id+"' and a.stage='"+stge+"' and date_format(a.due_date,'%d-%b-%y')='"+due_dt+"' and a.due_date_received='1')");
                                     while(rsChap.next())
                                     {
						   ...
						   //Fetch chapters
							...
							String estimatedRemark="";
                                ...
                                if(estimated_dateTime.equals("[No estimate yet]"))
                                    chapNoQuery="select a.chapter_no,a.chapter_id,trim(a.remark),mss_count from chapter a where (a.ship_date is null or a.ship_date = '0000-00-00 00:00:00') and a.proj_id='"+proj_id+"' and a.stage='"+stge+"' and date_format(a.due_date,'%d-%b-%y')='"+due_dt+"' and a.estimated_time is null and a.due_date_received='1' order by trim(a.remark) ";
                                else
                                    chapNoQuery="select a.chapter_no,a.chapter_id,trim(a.remark),mss_count from chapter a where (a.ship_date is null or a.ship_date = '0000-00-00 00:00:00') and a.proj_id='"+proj_id+"' and a.stage='"+stge+"' and date_format(a.due_date,'%d-%b-%y')='"+due_dt+"' and date(a.estimated_time)='"+estimated_dateTime+"' and a.due_date_received='1' order by trim(a.remark)";
