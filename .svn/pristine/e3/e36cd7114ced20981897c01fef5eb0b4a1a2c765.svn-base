 ...
 * @author pathfinder
 */
public class Salaryslipforind extends HttpServlet {
    ...
    throws ServletException, IOException,DocumentException  {
       ...
       fontT3 = new Font(bf, 6.0f);
        ...
        response.setContentType("text/html;charset=UTF-82");
...
monthVinwords = "DECEMBER";
      ...
      try
      {
          String forwritefilename = "C:/ScheduleExcel/Payslip_"+emp_idV1+"-"+monthV1+"-"+yearV1+".pdf";
         OutputStream file = new FileOutputStream(new File("C:/ScheduleExcel/Payslip_"+emp_idV1+"-"+monthV1+"-"+yearV1+".pdf"));
...
dispsalary.setEmp_code(emp_idV1);
...
BorderEvent event = new BorderEvent();
       ...
       PdfPTable table2part = new PdfPTable(4); // 3 columns.
        ...
        cellout1itememp = new PdfPCell(new Phrase("", subFont1));
...
//tableouter1.addCell(table2part);
        ...
        basic = new PdfPCell(new Phrase("  Baisc", fontT));
        ebasic = new PdfPCell(new Phrase("  Baisc", fontT));
        ...
        emptycellspay = new PdfPCell(new Phrase(" ", subFont));
        emptycellspay1 = new PdfPCell(new Phrase(" ", subFont));
        emptycellspay2 = new PdfPCell(new Phrase(" ", subFont));
        ...
        emptynexttoEva = new PdfPCell(new Phrase("", subFont));
        emptynexttoEvaV = new PdfPCell(new Phrase("", subFont));
...
emptytablecell = new PdfPCell(new Phrase(" ", subFont));
...
document.add(new Paragraph("\n"));
          document.add(table1);
           ...
           document.add(new Paragraph("\n"));
           document.add(new Paragraph("                Note: This is a system generated payslip, signatures are not required.", fontT3));
           document.add(new Paragraph("\n"));
           document.add(new Paragraph("\n"));
 ...
 writer.setPageEmpty(false);
       // document.newPage();
           ...
           // pathfinder.util.SendPayslip mdao= new pathfinder.util.SendPayslip();
            //mdao.sendEmailWithAttachments(dispsalary.getEmail(),forwritefilename,dispsalary.getMonthSyear());
      ...
      } catch (FileNotFoundException e)
      {
         ...
         // RequestDispatcher rd = request.getRequestDispatcher("/generatePayslip.jsp?&alrtmsg=Downloaded successfully");
