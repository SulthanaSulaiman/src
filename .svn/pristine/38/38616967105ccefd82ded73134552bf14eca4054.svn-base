...
public class ProjectOnTimeReportHeaderFooterDisp extends PdfPageEventHelper {
    PdfPTable header;
    PdfPTable footer;
...
public ProjectOnTimeReportHeaderFooterDisp() throws SQLException {

    header=headerClass.printerFilesOnTimeHeaderStyle();
    footer=headerClass.printerFilesOnTimeFooterStyle();
