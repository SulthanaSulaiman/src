...
public class BillingReportHeaderFooterDisp extends PdfPageEventHelper {
    PdfPTable header;
    PdfPTable footer;
...
public BillingReportHeaderFooterDisp() throws SQLException {

    header=headerClass.billingReportProjectsFilesHeaderStyle();
    footer=headerClass.billingReportProjectsFooterStyle();
