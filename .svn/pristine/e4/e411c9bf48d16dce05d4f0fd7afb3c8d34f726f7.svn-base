...
public class PlannerProjHeaderFooter extends PdfPageEventHelper {
PdfPTable header;
PdfPTable footer;
...
public PlannerProjHeaderFooter() throws SQLException {

header=headerClass.plannerHeaderStyle(1);
footer=headerClass.plannerFooterStyle();
