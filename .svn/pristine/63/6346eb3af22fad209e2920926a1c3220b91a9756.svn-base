...
public class ProductivityReportHeaderFooterDisp extends PdfPageEventHelper {
    ...
    public ProductivityReportHeaderFooterDisp() {

        header = headerClass.productivityReportHeaderStyle();
        footer = headerClass.productivityReportFooterStyle();
