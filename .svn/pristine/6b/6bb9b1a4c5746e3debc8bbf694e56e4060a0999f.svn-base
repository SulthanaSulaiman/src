...
public class ProfitReportHeaderFooterDisp extends PdfPageEventHelper {
...
public ProfitReportHeaderFooterDisp() throws SQLException {

    header=headerClass.profitReportHeaderStyle();
    footer=headerClass.profitReportFooterStyle();
