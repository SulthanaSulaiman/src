...
public class AppraisalServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            pathfinder.functions.hr.AppraisalDAO appraisalDAO = new pathfinder.functions.hr.AppraisalDAO();
            pathfinder.functions.hr.AppraisalVO appraisalVO = new pathfinder.functions.hr.AppraisalVO();
            ...
            response.sendRedirect("Appraisal.jsp?"+responseText);
